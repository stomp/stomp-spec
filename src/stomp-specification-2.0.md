# STOMP Protocol Specification, Version 2.0 (Draft)
...
and `CONNECTED` frames will also escape any colon or newline octet found in
...
* `server`  : A field that contains information about the STOMP server.
  ...
  comment feilds delimited by a space octet.
